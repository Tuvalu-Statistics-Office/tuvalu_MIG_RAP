...
dep <- dbGetQuery(mydb, "SELECT * FROM arrivals")
write.xlsx(arr,"C:/Users/lpele/OneDrive/Documents/CSD/03 SOCIAL/MIGRATION/2024/Q1/R_procData/Departures.xlsx", asTable = FALSE, overwrite = TRUE)